...
function casted_on(NPC, Spawn, SpellName)
    if SpellName == "Apply the Repellent" and GetQuestStep(Spawn, RepellingCritters) == 3 then
        ...
        raider = GetSpawnByLocationID(zone, 15)
        RemoveSpawnAccess(raider, Spawn)
        new = GetSpawnByLocationID(zone, 15)
        AddSpawnAccess(new, Spawn)
        SpawnRaider(new)

        raider = GetSpawnByLocationID(zone, 26)
        RemoveSpawnAccess(raider, Spawn)
        new = SpawnByLocationID(zone, 26)
        AddSpawnAccess(new, Spawn)
        SpawnRaider(new)

        raider = GetSpawnByLocationID(zone, 33)
        RemoveSpawnAccess(raider, Spawn)
        new = SpawnByLocationID(zone, 33)
        AddSpawnAccess(new, Spawn)
        SpawnRaider(new)

        raider = GetSpawnByLocationID(zone, 38)
        RemoveSpawnAccess(raider, Spawn)
        new = SpawnByLocationID(zone, 38)
        AddSpawnAccess(new, Spawn)
        SpawnRaider(new)

        raider = GetSpawnByLocationID(zone, 48)
        RemoveSpawnAccess(raider, Spawn)
        new = SpawnByLocationID(zone, 48)
        AddSpawnAccess(new, Spawn)
        SpawnRaider(new)

        raider = GetSpawnByLocationID(zone, 50)
        RemoveSpawnAccess(raider, Spawn)
        new = SpawnByLocationID(zone, 50)
        AddSpawnAccess(new, Spawn)
        SpawnRaider(new)

        raider = GetSpawnByLocationID(zone, 74)
        RemoveSpawnAccess(raider, Spawn)
        new = SpawnByLocationID(zone, 74)
        AddSpawnAccess(new, Spawn)
        SpawnRaider(new)
    end
end
