function hailed(NPC, Spawn)
	...
	AddConversationOption(conversation, "Yes, I am. I would love more of your cooking, Mooshga.", "Option6")
	...
	AddConversationOption(conversation, "What happened, Mooshga?", "Option7")
	...
	AddConversationOption(conversation, "Oh really, what are you making?", "Option8")
	...
	AddConversationOption(conversation, "What type are you making?", "Option9")
...
function Option1(NPC, Spawn)
	...
	AddConversationOption(conversation, "Come to think of it, I am hungry. What are you going to make?", "Option10")
...
function Option10(NPC, Spawn)
	...
	AddConversationOption(conversation, "Jerky sounds good. I'll do it.", "Option11")
...
function Option6(NPC, Spawn)
	...
	AddConversationOption(conversation, "What type of claws?", "Option12")
...
function Option12(NPC, Spawn)
	...
	AddConversationOption(conversation, "I'm getting hungrier by the minute.", "Option13")
...
function Option13(NPC, Spawn)
	...
	AddConversationOption(conversation, "Oh, that does sound yummy. I'll be right back.", "Option14")
...
function Option7(NPC, Spawn)
	...
	AddConversationOption(conversation, "Did you catch it?", "Option15")
...
function Option15(NPC, Spawn)
	...
	AddConversationOption(conversation, "Sure.", "Option16")
...
function Option16(NPC, Spawn)
	...
	AddConversationOption(conversation, "Ok, I'll be right back.", "Option17")
...
function Option8(NPC, Spawn)
	...
	AddConversationOption(conversation, "Yes, I think I know the one.", "Option18")
...
function Option18(NPC, Spawn)
	...
	AddConversationOption(conversation, "I will get some essences.", "Option19")
...
function Option19(NPC, Spawn)
	...
	AddConversationOption(conversation, "Ok, I'll be right back.", "Option20")
...
function Option9(NPC, Spawn)
	...
	AddConversationOption(conversation, "Ok. What do you need, Mooshga?", "Option21")
...
function Option21(NPC, Spawn)
	...
	AddConversationOption(conversation, "That sounds crunchy. I guess I can do it, though.", "Option22")
