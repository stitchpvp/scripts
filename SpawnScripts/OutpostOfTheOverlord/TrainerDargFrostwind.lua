function hailed(NPC, Spawn)
  ...
  AddConversationOption(conversation, "What can you teach me about combat?", "part1_teach")
  StartConversation(conversation, NPC, Spawn, "Greetings, %t. I've been stationed here at the outpost to teach new recruits the finer points of combat. After all, it's our duty to honor the Overlord by achieving legendary victories in his glorious name.")
...
function part1_teach(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "Teach me the basics of combat.", "part1_basics")
  AddConversationOption(conversation, "Teach me more advanced aspects of combat.", "part1_advanced")
  StartConversation(conversation, NPC, Spawn, "Well, what do you want to know? Something basic or something more advanced?")
end

function part1_basics(NPC, Spawn)
  local conversation = CreateConversation()

  tutorial_menu(conversation)
...
function part1_targeting(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "How do I begin the battle?", "part1_attacking")
...
function part1_attacking(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "So I can fight anyone or anything I want?", "part1_targets")
...
function part1_targets(NPC, Spawn)
  local conversation = CreateConversation()
...
function part1_ranged(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "How do I launch a ranged attack?", "part1_ranged_attack")
...
function part1_ranged_attack(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "What classes specialize in ranged combat?", "part1_ranged_classes")
...
function part1_ranged_classes(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "How do I tell if I can use spells or arts from a distance?", "part1_ranged_spells")
...
function part1_ranged_spells(NPC, Spawn)
  local conversation = CreateConversation()
...
function part1_rewards(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "What do you mean by \"a worthy opponent\"?", "part1_outlevel")
...
function part1_outlevel(NPC, Spawn)
  local conversation = CreateConversation()

  AddConversationOption(conversation, "Are certain types of targets more rewarding than others?", "part1_difficulty")
...
function part1_difficulty(NPC, Spawn)
  local conversation = CreateConversation()
...
function Option19(NPC, Spawn)
  ...
  tutorial_menu_advanced(conversation)

  StartConversation(conversation, NPC, Spawn, "You'll learn many advanced combat techniques over time. There's no substitute for experience, %t! I'd be happy to discuss a few of these advanced aspects, such as selecting the right opponent, knowing your surroundings, and using your abilities.")
end
...
function add_ready_option(conversation)
  AddConversationOption(conversation, "I am ready to fight.", "Option30")
end

function tutorial_menu(conversation)
  AddConversationOption(conversation, "Tell me how to begin a fight.", "part1_targeting")
  AddConversationOption(conversation, "Tell me about melee combat.", "part1_melee")
  AddConversationOption(conversation, "Tell me about ranged combat.", "part1_ranged")
  AddConversationOption(conversation, "What kind of rewards can I earn in battle?", "part1_rewards")
  AddConversationOption(conversation, "Teach me more advanced aspects of combat.", "part1_advanced")
  AddConversationOption(conversation, "I'll come back later.")
end

function tutorial_menu_advanced(conversation)
