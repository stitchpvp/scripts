...
function RouteTwo(NPC)
	...
	local Z = GetZ(NPC)
    MovementLoopAddLocation(NPC, X, Y, Z, 2, math.random(2,10))
    MovementLoopAddLocation(NPC, X - 3, Y, Z, 2, math.random(20,45))
	MovementLoopAddLocation(NPC, X - 2, Y, Z - 8, 2, math.random(20,45))
	MovementLoopAddLocation(NPC, X + 3, Y, Z, 2, math.random(20,45))
	MovementLoopAddLocation(NPC, X - 4, Y, Z - 9, 2, math.random(20,45))
