...
function CraftingTutorHail(NPC, Spawn)
	...
	elseif CanReceiveQuest(Spawn, TutorialOutfitting) then
		Tut7Chat1(NPC, Spawn)
	elseif HasQuest(Spawn, TutorialOutfitting) and (not QuestStepIsComplete(Spawn, 97, 1) or not QuestStepIsComplete(Spawn, 97, 2)) then
		PlayFlavor(NPC, "", "Take your time. It's dangerous to rush at the forge!", "", 0, 0, Spawn)
	elseif HasQuest(Spawn, TutorialOutfitting) and QuestStepIsComplete(Spawn, 97, 1) and QuestStepIsComplete(Spawn, 97, 2) then
