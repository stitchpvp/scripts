...
function Init(Quest)
	AddQuestStepSpell(Quest, 1, "I need to destroy the evil spirit bound to the cavalier statue located near Val'Marr.", 1, 100, "I need to cleanse the sacred cavalier statue near Val'Marr. Evil spirits have recently attached themselves to there.", 11, --[[ ID's --]])
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepSpell(Quest, 2, "I need to destroy the evil spirit bound to the cavalier statue located where the Avatar of War was defeated.", 1, 100, "I need to cleanse the sacred cavalier statue where the Avatar of War met his demise. An evil spirit has recently attached itself to there.", 11, --[[ ID's --]])
...
function Step2Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepSpell(Quest, 3, "I need to destroy the evil spirits bound to the cavalier statues located at the end of a path.", 1, 100, "I need to cleanse the sacred cavalier statues where the road ends. Evil spirits have recently attached themselves there.", 11, --[[ ID's --]])
...
function Step3Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "Speak to Sir Groktog near the ruins of Val'marr.", 1, "I need to report back to Sir Groktog and tell him of the cleansing of the statues.", 11, --[[ ID's --]])
