...
function Init(Quest)
	AddQuestStepLocation(Quest, 1, "I need to place some Bloodskull Frenzy Root near 5 living Ree orcs", 5, "I need to use the treated root samples to corrupt some Ree orcs. I also need a current copy of their orders.", 197, --[[ ID's --]])
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 2, "I need to obtain a recent copy of the orders for the Ree orcs west of Dog Trapper Lake/", 1, 100, "I need to use the treated root samples to corrupt some Ree orcs. I also need a current copy of their orders.", 75, --[[ ID's --]])
...
function Step2Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "I need to return to Ventar", 1, "Now that I have done as he asked, I should return to Ventar.", 11, --[[ ID's --]])
