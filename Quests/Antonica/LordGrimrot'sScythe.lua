...
function Init(Quest)
	AddQuestStepChat(Quest, 1, "Grel Stoneshearer overlooks the Keep of the Ardent Needle from a nearby hilltop.", 1, "I need to speak with the dwarven knights in Antonica.", 11, --[[ ID's --]])
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "Grelda Stoneshearer is near the Keep of the Gnollslayers.", 1, "I need to speak with the dwarven knights in Antonica.", 11, --[[ ID's --]])
...
function Step2Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "Morte Winghammer is near a covered bridge.", 1, "I need to speak with the dwarven knights in Antonica.", 11, --[[ ID's --]])
...
function Step3Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "Ignar Steadirt is near the Qeynos' Claymore memorial.", 1, "I need to report back to Ignar Steadirt.", 11, --[[ ID's --]])
...
function Step4Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 5, "The Sabertooth rune casters possess a part of the scythe.  They are northeast of Archer's Wood, east down the path, approaching Bramble Woods in Antonica.", 1, 100, "I need to obtain Lord Grimrot's scythe from the gnolls.", 640, --[[ ID's --]])
...
function Step5Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "Ignar is near the Qeynos' Claymore memorial.", 1, "I need to report to Ignar Steadirt.", 11, --[[ ID's --]])
...
function Step6Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 7, "This piece is with the Darkpaw rune casters in Bramble Woods in Antonica.", 1, 100, "I must destroy the remaining piece of Lord Grimrot's war scythe.", 640, --[[ ID's --]])
...
function Step7Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 8, "Ignar Steadirt is near the Qeynos Claymore memorial.", 1, "I need to return to Ignar Steadirt.", 11, --[[ ID's --]])
...
function Step8Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 9, "Grimbold Steadirt is near the entrance to Firemyst Gully.", 1, "I need to seek Grimbold Steadirt, the dwarven centurion.", 11, --[[ ID's --]])
